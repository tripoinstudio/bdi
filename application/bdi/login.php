...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <body id="login-body">
        ...
        <div id="login">
            <!-- BEGIN LOGIN FORM -->
            <form id="loginform" class="form-vertical no-padding no-margin" action="proseslogin.php" method="post">
                <div class="lock">
                    <i class="icon-lock"></i>
                </div>
                <div class="control-wrap">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <div class="input-prepend">
                                <span class="add-on"><i class="icon-key"></i></span><input name="company" id="input-password" type="text" placeholder="Company Code" />
                            </div>
                            <div class="mtop10">
