                ...
                foreach ($list_menu as $menua) {
                    ...
                    <tr>
                        ...
                        <th style="text-align:center;width:30%;vertical-align: middle;" class="hidden-phone">
                            ...
                            ?></th>
                        <th style="width:5%;text-align:center;vertical-align: middle;" class="hidden-phone"><input type="checkbox" id="viewc<?= $noi; ?>" value="<?= $minsa[0]; ?>" /></th>
                        <th style="width:5.5%;text-align:center;vertical-align: middle;" class="hidden-phone"><input type="checkbox" id="createc<?= $noi; ?>" value="<?= $minsa[1]; ?>"/></th>
                        <th style="width:5%;text-align:center;vertical-align: middle;" class="hidden-phone"><input type="checkbox" id="editc<?= $noi; ?>" value="<?= $minsa[2]; ?>"/></th>
                        <th style="width:4.3%;text-align:center;vertical-align: middle;" class="hidden-phone"><input type="checkbox" id="deletec<?= $noi; ?>" value="<?= $minsa[3]; ?>"/></th>
