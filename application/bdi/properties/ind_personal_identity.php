...
define('ALAMAT_TINGGAL1','ALAMAT TINGGAL SEBELUMNYA #1');
define('TELP_RUMAH1','Telp Rumah');
define('TGL_PRBH_ALMT1','Tanggal Perubahan Alamat #1');
define('TELP_RUMAH2','Telp Rumah');
define('ALAMAT_TINGGAL2','ALAMAT TINGGAL SEBELUMNYA #2');
define('TGL_PRBH_ALMT2','Tanggal Perubahan Alamat #2');
define('NO_HANDPHONE','No Handphone');
define('EMAIL','Alamat Email');
...
define('SENTRA','Sentra');
define('DISTRIK','Distrik');
define('CETYA','Cetya');
