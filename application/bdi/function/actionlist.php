<!--    <a data-original-title="View" data-placement="top" rel="tooltip" class="btn btn-small"><i class="gicon-eye-open"></i></a> -->
    ...
    if ($_SESSION['backend'] == 1) {
        if (($_GET['content'] == 'user')) {
            ...
            <?php if ($cekaction[2] == 2) { ?>
                ...
                <button class="btn btn-primary" onclick="viewEdit('<?= $cekMenu['menu_function_link']; ?>', '<?= $array_list_query[$cekMenu['menu_function_link'] . '_id']; ?>', 'view');"><i class="icon-pencil icon-white"></i> Edit</button>
            <?php } ?>
        ...
        <?php } else { ?>
            <?php if ($cekaction[2] == 2) { ?>
                <a href="javascript:void(0)" onclick="viewEdit('<?= $cekMenu['menu_function_link']; ?>', '<?= $array_list_query['tb_' . $cekMenu['menu_function_link'] . '_id']; ?>', 'view');" data-original-title=" Edit" data-placement="left" rel="tooltip" class="btn btn-small"><i class="gicon-edit"></i></a> 
