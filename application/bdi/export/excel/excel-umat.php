...
while ($array_list_query = mysql_fetch_array($list_query)) {
    ...
    if ($no == 1) {
        ...
        <table class="table" border=1 >
            <thead>
                <tr>
                    <td style="border: black; padding-top: 90px; padding-bottom: 10px; padding-right: 7px; ">NO</td>
            ...
            <tr>
                ...
                <td style="border: black; padding-top: 10px; padding-bottom: 10px; padding-right: 7px; text-align: center; width: 350px;"><?= $array_list_query['tb_data_umat_alamat_tinggal']; ?></td>
            </tr>
        <?php } ?>    
    </tbody>
</table>
