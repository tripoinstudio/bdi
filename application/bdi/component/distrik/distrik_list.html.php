...
<div class="inline"><button onclick="return addSentra(0,2);" id="createitem" class="btn btn-primary" data-original-title="" title=""><i class="gicon-plus"></i> Tambah Distrik</button>
