...
//        }
       ...
       //     $group = $query1['tb_group_id'];
            $db->insert('tb_relationship', array('tb_relationship_relation_code' => $nameHub, 'tb_data_umat_id' => $nameKel, 'tb_relationship_relationship_id' => $idkeluarga1));  // Table name, column names and respective values
		...
		$db->insert('tb_relationship', array('tb_relationship_relation_code' => $nameHubs, 'tb_data_umat_id' => $nameKels, 'tb_relationship_relationship_id' => $idkeluarga2));  // Table name, column names and respective values
...
//        $res3 = $dbs->getResult();
   ...
   //     $id = $_GET['id'];
		...
		$db->update('tb_family_relationship', array('tb_data_umat_id' => $code_umat_id, 'tb_family_relationship_type' => 1), 'tb_family_relationship_id=' . $id_name1 . '');  // Table name, column names and respective values
        $res4 = $db->getResult();
        
        $db->update('tb_family_relationship', array('tb_data_umat_id' => $code_umat_id, 'tb_family_relationship_type' => 2), 'tb_family_relationship_id=' . $id_name2 . '');  // Table name, column names and respective values
        $res5 = $db->getResult();
