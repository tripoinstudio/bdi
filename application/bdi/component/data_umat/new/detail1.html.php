...
<?= inputGeneralTemplate(TELP_RUMAH, '
                    <input type="text"  id="first_telp_rumah" name="truetitles[]" onkeypress="return maxFourNumber(event,this)" placeholder="021" class="span1" /> - 
                    <input type="text"  id="last_telp_rumah" name="truetitles[]" onkeyup="return maxEightNumber(event,this);" placeholder="12345678" class="span4" />
                    ');
?>
...
<?= inputGeneral('081567891011', NO_HANDPHONE, 'no_handphone', 'true', $_GET['action'],'','onkeypress="return maxTwelveNumber(event,this)"'); ?>
