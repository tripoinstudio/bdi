<div class="content">
	...
	<td ><?=$creupddate;?>|<?=$creupdhost;?>|<?=$creupd;?></td>
        ...
        <a id="export-pdf-detail" class="btn btn-info color_7" onclick="exportPdfUmat('pdf','pdf-detail-data-umat','&id=<?=$_GET['id']?>');" href="javascript:void(0)" data-original-title="" title=""><span class="icon-file"> EXPORT DETAIL UMAT PDF</span></a>
        <a id="export-excel-detail" class="btn btn-info color_12" onclick="exportExcelUmat('excel','excel-detail-data-umat','&id=<?=$_GET['id']?>');" href="javascript:void(0)" data-original-title="" title=""><span class="icon-book"> Excel</span></a>
	</div>